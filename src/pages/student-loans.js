    ...
    <div className={"container mx-auto"}>
      ...
      >
        <a
          href="/"
          className={
            "text-sm text-light-gray hover:text-dark-gray transition duration-150 ease-in-out"
          }
        >
          Home
        </a>
        ...
        <span
          className={
            "text-sm text-light-gray transition duration-150 ease-in-out"
          }
        >
      ...
      <div className={"flex row"}>
        <div className={"w-4/5 pr-20 text-light-gray"}>
          ...
          <section className={"py-15 border-b border-dirty-white"}>
            ...
            <a href="#" className={"text-deep-blue text-link underline block"}>
            ...
            <div className={"grid gap-8 mt-10 md:mt-0 order-1 xl:order-none"}>
              <div className={"md:grid md:grid-cols-2 md:gap-8"}>
                <article>
                  ...
                  <p className={"text-light-gray text-base my-2"}>
                  ...
                  <a href="#" className={"text-deep-blue text-link underline"}>
                    Article Link
                  </a>
                </article>
                <article>
        ...
        <div className={"in-this-section w-1/5"}>
          <h5
            className={
              "uppercase text-h5 font-semibold font-body border-b border-dirty-white py-1"
            }
          >
            In this section
          </h5>
          <nav>
            <li
              className={
                "group active flex items-center pr-2 py-1 text-link leading-5 font-bold text-deep-blue hover:font-bold focus:font-bold focus:outline-none transition ease-in-out duration-150"
              }
              aria-current="page"
            >
            ...
            <li
              className={
                "mt-1 group flex items-center pr-2 py-1 text-link leading-5 font-normal text-deep-blue hover:font-bold focus:outline-none focus:font-bold transition ease-in-out duration-150"
              }
            >
              <a href={""} className={"truncate text-deep-blue text-link"}>
