  ...
  <Layout>
    ...
    <div class="container mx-auto">
      <nav class="hidden sm:flex items-center leading-5 font-sm mb-10">
        <a href="/" class="text-sm text-light-gray hover:text-dark-gray transition duration-150 ease-in-out">Home
        </a>
        <span class="text-sm mx-2 text-light-gray">/</span>
        <span class="text-sm text-light-gray transition duration-150 ease-in-out">Student loans, forgiveness
        </span>
      </nav>
      <div class="flex row">
        <div class="w-4/5">
          ...
          <section>
            ...
            <div class="grid gap-8 mt-10 md:mt-0 order-1 xl:order-none">
              <div class="md:grid md:grid-cols-2 md:gap-8">
                <article>
                  <h3>Article Title</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus ad, alias consequatur cum dolores et expedita hic illo ipsum laudantium neque nesciunt, nihil nulla perspiciatis quidem quod quos ratione sunt!</p>
                  <a href="#" class="text-deep-blue underline">Article Link</a>
                </article>
                <article>
                  <h3>Article Title</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus ad, alias consequatur cum dolores et expedita hic illo ipsum laudantium neque nesciunt, nihil nulla perspiciatis quidem quod quos ratione sunt!</p>
