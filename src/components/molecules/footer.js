...
const Footer = () => {
  ...
  return (
    <div className="bg-gray-800">
      <nav className="border-b border-t border-gray-700">
        <div className="container text-white font-display font-bold py-4 flex flex-wrap justify-between px-4 sm:px-6 lg:px-8 ">
          <div className="py-2">
      ...
      <nav className="container">
        <div className="text-white font-body text-sm py-4 flex flex-wrap px-4 sm:px-6 lg:px-8 divide-x-1 divide-gray-700 self-start">
          <div className="mb-4 py-1 pr-4">
