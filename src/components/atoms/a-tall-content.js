      ...
      <div className="w-full sm:w-1/2 lg:w-1/4">
        <Link to={props.link}>
          <div className="flex items-end w-full bg-gray-100 sm:py-12 py-16 sm:px-12 px-6 relative h-banner">
            {image ? <Img fluid={image} className={"w-full object-cover h-full object-center block absolute inset-0"} style={{position: "absolute"}} /> : null}
            <div className="relative z-10 w-full ">
              <h2 className="text-lg font-display font-medium title-font mb-2">{props.heading}</h2>
